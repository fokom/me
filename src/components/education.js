                    ...
                    <div className="panel panel-default">
                      <div className="panel-heading" role="tab" id="headingOne">
                        <h4 className="panel-title">
                          <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">BEng Computer Engineering
                          </a>
                        </h4>
                      </div>
                        ...
                        <div className="panel-body">
                          <div className="row">
                            <div className="col-md-6">
                              <p>Faculty of Engineering and Technology, Buea Cameroon</p>
                            </div>
                            <div className="col-md-6">
                              <p></p>
                            </div>
