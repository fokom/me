  ...
  render() {
    return (
      <React.Fragment>
          ...
          <section id="work" className="colorlib-experience" data-section="experience">
                  ...
                  <div className="timeline-centered">
                    <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                      <div className="timeline-entry-inner">
                        ...
                        <div className="timeline-label">
                          <h2><a href="#">Front End Developer @ LONITE AG</a> <span>2018-Present</span></h2>
                          <p></p>
                        </div>
                      </div>
                    </article>
                    <article className="timeline-entry animate-box" data-animate-effect="fadeInRight">
                      <div className="timeline-entry-inner">
                        ...
                        <div className="timeline-label">
                          <h2><a href="#">IT ADMIN @ LONITE AG</a> <span>2017-2021</span></h2>
                          <p></p>
                        </div>
                      </div>
                    </article>
